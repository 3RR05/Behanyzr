...
## 📊 Behanyzr - Behavior Drift Analyzer ~
 ...
 A web applicatoin that track and analyze behavior and sentiment drifts using data scraped from Reddit/NewsAPI (Able to scrap from other social media if changes some logics in Utility modules).
...
<h1 style="font-family:'Pixelify Sans';font-size:50px;text-align:center">3RR05</h1>
